    ...
    return (
        <>
            ...
            <div className="my_cart_background m-0 p-0">
                        ...
                        <table className="col-12">
                            <tbody>
                                <tr className="col-12 cart_table">
                                    ...
                                    <th className="col-3 pt-2 pb-2" style={{ paddingLeft: '30px', paddingRight: '30px', borderStyle: 'solid', borderColor: 'black' }}>Item Name{name}</th>
                                    ...
                                    <th className="col-1 pt-2 pb-2" style={{ paddingLeft: '30px', paddingRight: '30px', borderStyle: 'solid', borderColor: 'black' }}>Time{time}</th>
                                </tr>
                            </tbody>
                        </table>
                        <Cart_table />
                ...
                <div className="col-11 d-flex"style={{gap:"13%",paddingLeft:'5rem'}}>
                    <div className="col-3 m-0 p-0" style={{ marginLeft:"10rem", height: "3.3rem", display: "flex", alignItems: "center"}}>
                        <button className="col-6 m-0 p-0 btn btn-success" style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100%"}}>
                            <h5 style={{ margin: 0,fontSize:"1.5rem" }}>Total :</h5>
                        </button>
                    </div>
                    <button className="btn btn-success pl-5 pr-5 pt-3 pb-2 ml-5" style={{ marginLeft: '50px',display: "flex", justifyContent: "center", alignItems: "center" }} onClick={handleOrderNow} data-toggle="modal" data-target="#orderModal">
