...
const Table_row = ({ serial, name, phone, address, time, id, delivery_sts, payment_sts, payment_mode, payment_id, food, price ,otp,deliveryBoyName,deliveryBoyPhone}) => {
    ...
    return (
        <>
            <div className="col-12 m-0 p-0 d-flex pt-1 pb-1" style={{ boxShadow: 'rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px'}}>
                ...
                <div className="col-3" style={{ boxShadow: 'rgba(0, 0, 0, 0.05) 0px 0px 0px 1px'}}>{address}</div>
                <div className="col-2" style={{ boxShadow: 'rgba(0, 0, 0, 0.05) 0px 0px 0px 1px'}}>{time}</div>
                <div className="col-2" style={{ boxShadow: 'rgba(0, 0, 0, 0.05) 0px 0px 0px 1px'}}>{id}</div>
                <div className="col-1" style={{ boxShadow: 'rgba(0, 0, 0, 0.05) 0px 0px 0px 1px'}}>{delivery_sts}</div>
                <div className="col-2" style={{ boxShadow: 'rgba(0, 0, 0, 0.05) 0px 0px 0px 1px'}}>{deliveryBoyName}</div>
                <div className="col-1" style={{ boxShadow: 'rgba(0, 0, 0, 0.05) 0px 0px 0px 1px'}}>{deliveryBoyPhone}</div>
                ...
                <div className="col-1" style={{ boxShadow: 'rgba(0, 0, 0, 0.05) 0px 0px 0px 1px'}}>{otp}</div>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div className=""><h6>Total Price:</h6></div>
